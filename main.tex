...
\usepackage[alf,citeyear]{abntex2cite}    % Citações padrão ABNT
...
% ---
\titulo{Autenticidade em registro de frequência em sala de aulas via Reconhecimento Facial e Geolocalização Indoor}
\autor{Luan Coêlho de Souza}
\local{Palmas}
\data{2023}
\orientador{Prof. Me. Jânio Elias Teixeira Júnior}
\instituicao{
...
na disciplina de Trabalho de Conclusão de Curso I do Curso de
